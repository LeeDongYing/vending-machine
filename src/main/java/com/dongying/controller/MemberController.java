...
public class MemberController {
	...
	public ResponseEntity<MemberInfo> checkLogin() {
		...
		MemberInfo member = MemberInfo.builder().isLogin(sessionMemberInfo.isLogin()).build();

		String customerName = sessionMemberInfo.getCustomerName();
		String identificationNo = sessionMemberInfo.getIdentificationNo();
		if (!"".equals(customerName) && !"".equals(identificationNo)) {
	...
	public ResponseEntity<MemberInfo> login(@RequestBody MemberInfo member) {
		/*
		 * { "identificationNo": "A124243295", "cusPassword": "123" } {
		 * "identificationNo": "G436565447", "cusPassword": "123" }
		 */
